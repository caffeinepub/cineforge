...
import type { SubscriptionStatus as _SubscriptionStatus, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProject(arg0: string, arg1: Array<Clip>, arg2: Array<TextOverlay>, arg3: string): Promise<Project> {
        if (this.processError) {
            try {
    ...
    async downgradeSubscription(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.downgradeSubscription();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listFavoritePresets(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.listFavoritePresets();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeFavoritePreset(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeFavoritePreset(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveFavoritePreset(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveFavoritePreset(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async trackUsage(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.trackUsage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProject(arg0: string, arg1: string, arg2: Array<Clip>, arg3: Array<TextOverlay>, arg4: string): Promise<Project> {
        if (this.processError) {
            try {
    ...
    async updateUserProfile(arg0: string): Promise<UserProfile> {
        if (this.processError) {
            try {
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        plan: value.plan,
        upgradeDate: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.upgradeDate))
    };
}
